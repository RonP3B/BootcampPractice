...
namespace MVC
{
    public static class Views
    {
        ...
        public static class SportStore
        {
            public static class Customer
            {
                public const string CustomerIndex = "~/Modules/SportStore/Customer/CustomerIndex.cshtml";
            }

            public static class Order
            {
                public const string OrderIndex = "~/Modules/SportStore/Order/OrderIndex.cshtml";
            }

            public static class OrderDetail
            {
                public const string OrderDetailReport = "~/Modules/SportStore/OrderDetail/OrderDetailReport.cshtml";
            }

            public static class Product
            {
                public const string ProductIndex = "~/Modules/SportStore/Product/ProductIndex.cshtml";
            }
        }
    }
}
